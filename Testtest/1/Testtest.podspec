...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/sun6boys/Testtest"
  ...
  s.source       = { :git => "https://github.com/sun6boys/Testtest.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Testtest/Testtest/**/*.{h,m}"
